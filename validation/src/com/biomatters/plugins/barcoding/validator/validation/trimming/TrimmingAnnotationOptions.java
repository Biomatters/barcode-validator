...
/**
 * @author Gen Li
 *         Created on 21/08/14 3:25 PM
 */
public class TrimmingAnnotationOptions extends Options {
    private final ErrorProbabilityOptions errorProbabilityOptions = new ErrorProbabilityOptions();

    public TrimmingAnnotationOptions() {
        addChildOptions("errorProbability", "", "", errorProbabilityOptions, true);
    }
    ...
    public double getErrorProbabilityLimit() {
        return errorProbabilityOptions.getErrorProbabilityLimit();
    }
}